...
<div class="authContainer">
	<form>
		...
		<!----This part is to check when the button submit is click this will show-->
		{#if error}
		...
		<!--This part is to differentiate the label of confirm password in the register to a login-->
		{#if register}
			<label>
	...
	<!--To choose if its either register or login-->
	<div class="options">
		<p>Or</p>
		{#if register}
			<div>
